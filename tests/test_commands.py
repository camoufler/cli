...
from camaflouge_cli.commands import cmd_download, cmd_standardize, read_stdin
from camaflouge_cli.config import AppConfig
...
@patch("camaflouge_cli.commands.pull_model")
...
@patch("camaflouge_cli.commands.chat_standardize", return_value="I will leave later.")
@patch("camaflouge_cli.commands.read_stdin", return_value="gonna head out later")
